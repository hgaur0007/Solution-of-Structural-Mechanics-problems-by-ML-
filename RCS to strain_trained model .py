...
import matplotlib.pyplot as plt
X_test = np.array([[-0.999, -0.986063428, -0.973129442, -0.960198042, -0.947269226, -0.934342994, -0.921419344, -0.908498275, -0.895579787, -0.869750547, -0.734315981, -0.663487066, -0.599164371, -0.51564037, -0.393760493, -0.329705304, -0.259317778, -0.195395511, -0.125153894, -0.061363997, 0.008732313, 0.072390387, 0.142341991, 0.205868786, 0.27567628, 0.339072335, 0.408736312, 0.472002165, 0.541523214, 0.604659398, 0.674038104, 0.73704515, 0.806282094, 0.818862672, 0.938256291]])
X_test= X_test.T
...
plt.scatter(RCS, t_strain/100, color='red', label='Experimental data')
plt.plot(X_test, activation3.output/100, color='green', label='Output from Neural Network')
plt.legend()
